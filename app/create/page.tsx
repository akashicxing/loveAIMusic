                ...
                onClick={async () => {
                  if (selectedMusicStyle && completeLyrics && finalTitle) {
                    try {
                      ...
                      toast({
                        title: '开始生成音乐 🎵',
                        description: '正在为你的歌词配乐，这可能需要几分钟...',
                      });
                      ...
                      if (musicResult.success) {
                        toast({
                          title: '音乐生成任务已提交 ✅',
                          description: `任务ID: ${musicResult.data.taskId}，请稍后查询状态`,
                        });
                        console.log('音乐生成任务已提交:', musicResult.data);
                      } else {
                        toast({
                          title: '音乐生成失败',
                          description: musicResult.error || '未知错误',
                          variant: 'destructive',
                        });
                      }
                    } catch (error) {
