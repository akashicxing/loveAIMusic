...
import { Menu, X, Heart, Chrome as Home, Music2, Sparkles, Library, Info } from 'lucide-react';
        ...
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-xl sm:text-2xl font-bold text-gradient leading-tight">为爱而歌</span>
              <span className="text-[10px] sm:text-xs text-pink-200/60 font-light tracking-wider">AI Love Song Creator</span>
            </div>
          </Link>
